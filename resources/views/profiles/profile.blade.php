...
<div class="post-block typeB-profile" style="position: relative; padding-left: 110px;">
  <div class="post-header">
    <div class="post-left">
      <img src="{{ asset('images/' . $user->icon_image) }}" class="user-icon" style="margin-top: 6px;">
      <div class="post-user-info" style="display: flex; flex-direction: column; gap: 15px; justify-content: center;">
...
<!-- bio行 -->
<div style="display: flex; align-items: center;">
  <span style="min-width: 200px;">bio</span>
